...
<div class="row">
    <div class="leftcolumn">
        <div class="library_menu">
            ...
            <div class="panel">
                <div class="library_element" name="Custom formula">
                    Custom formula
                </div>
                <div class="library_element" name="grep">
                    grep
                </div>

            </div>
            <button class="accordion">Environment Modification</button>
            <div class="panel" >
                <div class="library_element" name="DB connection">
                    DB connection
                </div>
                <div class="library_element" name="SSH">
                    SSH
                </div>
                <div class="library_element" name="cd">
                    cd
                </div>
            </div>
        </div>
